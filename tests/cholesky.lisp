...
(LISP-UNIT:DEFINE-TEST CHOLESKY
  ...
  (LISP-UNIT:ASSERT-NUMERICAL-EQUAL
   (LIST
    (MAKE-MARRAY 'DOUBLE-FLOAT :DIMENSIONS '(4 4) :INITIAL-CONTENTS
  ...
  (LISP-UNIT:ASSERT-NUMERICAL-EQUAL
   (LIST
    (MAKE-MARRAY 'DOUBLE-FLOAT :DIMENSIONS '(12 12) :INITIAL-CONTENTS
