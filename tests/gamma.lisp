...
(LISP-UNIT:DEFINE-TEST GAMMA
  ...
  (ASSERT-TO-TOLERANCE (POCHAMMER -9.0d0 -3.5d0) 0 +TEST-TOL0+)
  ...
  ; Input domain error; error in gamma.c at line 769
  ...
  (ASSERT-TO-TOLERANCE (COMPLEMENTARY-INCOMPLETE-GAMMA 10.0d0 1.0d-16) 2.755731922398588814734648067d-167
		       +TEST-TOL2+)
  ;; Exceeded max number of iterations; error in gamma_inc.c at line 99
  #+(or)
